...
void LoadOffsetsFromJSON(const char* path) {
    ...
    const char* keys[] = {
        "dwEntityList", "dwGameEntitySystem_highestEntityIndex", "dwViewMatrix", "dwViewAngles", "dwViewRender", "dwGlobalVars", "dwLocalPlayerController", "dwLocalPlayerPawn", "dwWeaponC4", "dwCSGOInput", "dwThirdPersonPatch", "dwThirdPersonValue", "dwViewPunchDecayConVar", "m_pActionTrackingServices", "m_iNumRoundKills",
        ...
        "m_bPawnHasDefuser", "m_bIsScoped", "m_zoomLevel", "m_vecViewOffset", "m_bThrowAnimating", "m_fThrowTime", "m_flThrowStrength", "m_pAimPunchServices", "m_predictableBaseAngle", "m_predictableBaseAngleVel", "m_unpredictableBaseAngle",
